...
from siga_api.views import ProfessorViewSet, CursoViewSet, AlunoViewSet, DisciplinaViewSet, GradeDeAulasViewSet, LecionaViewSet, AtividadeViewSet,Horarios_AulasViewSet
